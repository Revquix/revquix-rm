 ...
 * File: RolesParserUtil.java
 */

/**
 * RolesParserUtil provides a utility method to parse and aggregate roles from a list of Role objects.
 */
@UtilityClass
public class RolesParserUtil {

    public static List<String> parseRoles(List<Role> roles) {
